      ...
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <NavLink path="/series" label="Series" currentPath={pathname} />
            <NavLink path="/movies" label="Movies" currentPath={pathname} />
            <NavLink path="/new" label="New & Notable" currentPath={pathname} />
            <NavLink path="/library" label="My Library" currentPath={pathname} />
            <Link
              href="/favorites"

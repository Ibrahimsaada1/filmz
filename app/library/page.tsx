        ...
        {movies.length === 0 ? (
          <div className="bg-gray-800 rounded-lg p-8 text-center max-w-2xl mx-auto">
            <div className="text-gray-400 mb-6">
              ...
              <p className="mb-6">You haven't purchased any movies yet. Browse our collection and buy your first movie to start building your library.</p>
            </div>
            <Link 
              href="/movies" 
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {movies.map((movie) => (
                <div key={movie.id} className="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-transform hover:scale-105 flex flex-col h-full">
                  <Link href={`/movies/watch/${movie.id}`} className="block relative aspect-[2/3]">
                    <Image
                      src={movie.thumbnailUrl ? getTMDBImageUrl(movie.thumbnailUrl) : '/placeholder-poster.png'}
                      alt={movie.title}
                      fill
                  ...
                  <div className="p-4 flex-grow flex flex-col">
                    ...
                    <div className="mt-auto space-y-3">
                      <div className="flex items-center text-sm text-gray-400">
                        ...
                        <span>Purchased: {new Date(movie.purchaseDate).toLocaleDateString()}</span>
                      </div>
